...
def task_descriptor_for_package_and_initial_task(package_dict, start_handler, start_args, package_path, master_uri,
    ...
    def resolve_arg(value):
        try:
            ...
            if "default" in value:
                print >> sys.stderr, "Positional argument", value["__args__"], "not specified; using default", value[
                    "default"]
    ...
    def resolve_env(value):
        try:
            ...
            if "default" in value:
                print >> sys.stderr, "Environment variable", value["__env__"], "not specified; using default", value[
                    "default"]
                return value["default"]
            else:
